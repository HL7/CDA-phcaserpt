# Project Name: Public Health Case Report Update

**Project Insight Number**: [1216](https://www.hl7.org/special/Committees/projman/searchableProjectIndex.cfm?action=edit&ProjectNumber=1216)

**Sponsoring Workgroup**: Public Health

**Repo Description**: CDA Implementation Guide XML and supporting files

# Product Name: HL7 CDA® R2 Implementation Guide: Public Health Case Report - the Electronic Initial Case Report (eICR)
...
## Latest Ballot: HL7 CDA eICR R4.0.0 (Ballot)


# Product Name: HL7 CDA® R2 Implementation Guide: Reportability Response (RR) File

## Description
The purpose of this IG the generation of a Reportability Response from public health and their representatives and Reportability Response use within clinical care organizations and PHAs.

**HL7 RR Product Brief**: https://www.hl7.org/implement/standards/product_brief.cfm?product_id=470
